package com.zhaoyan.ladderballmanager.util;
...
public class Log {
    ...
    private static final String APP_LOG_TAG = "LBManager/";
    private static final String APP_NETWORK_TAG = "LBManagerNetwork/";
