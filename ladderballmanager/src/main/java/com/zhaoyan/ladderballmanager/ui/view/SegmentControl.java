package com.zhaoyan.ladderballmanager.ui.view;
...
public class SegmentControl extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec){
        ...
        if(mTexts != null && mTexts.length > 0){
            ...
            mChildrenWidth = mDirection == Direction.HORIZONTAL ? mSingleChildWidth * mTexts.length : mSingleChildWidth;
