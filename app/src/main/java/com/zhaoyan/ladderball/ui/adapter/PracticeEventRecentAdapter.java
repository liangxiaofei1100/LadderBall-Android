 ...
 */
public class PracticeEventRecentAdapter extends RecyclerView.Adapter<PracticeEventRecentAdapter.RecentRecordViewHolder> {

    private Context mContext;

    private LayoutInflater mInflater;

    private List<TmpEventItem> mDataList;


    public PracticeEventRecentAdapter(Context context) {
        mContext = context;
    ...
    public void setDataList(List<TmpEventItem> dataList) {
        mDataList = dataList;
    }
    ...
    public void addItem(TmpEventItem eventItem) {
    ...
    public TmpEventItem getItem(int position) {
    ...
    public void onBindViewHolder(RecentRecordViewHolder holder, int position) {
        TmpEventItem eventItem = mDataList.get(position);
    ...
    public class RecentRecordViewHolder extends RecyclerView.ViewHolder {
        ...
        void removeEvent() {
            ...
            dataRecord.itemType = RxBusTag.PracticeDataRecord.ITEM_EVENT_RECENT_REMOVE;
