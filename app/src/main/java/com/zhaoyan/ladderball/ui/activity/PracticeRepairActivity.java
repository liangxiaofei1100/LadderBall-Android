...
import com.zhaoyan.ladderball.ui.dialog.PracticeRepairDialog;
...
public class PracticeRepairActivity extends BaseActivity implements OnItemClickListener {
    ...
    public static Intent getStartIntent(Context context, long matchId, long teamId, int partNumber, boolean isComplete) {
        ...
        intent.setClass(context, PracticeRepairActivity.class);
    ...
    private void doGetEventList() {
        ...
        Observable<EventPartListResponse> responseObservable
                = mLadderBallApi.doGetTmpEvetPartList(request).subscribeOn(Schedulers.io());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == android.R.id.home) {
            PracticeRepairActivity.this.finish();
        } else if (itemId == 0) {
            //add new record
            showAddDialog();
        }
    ...
    private void showAddDialog() {
        List<TmpPlayer> playerList = new Select().from(TmpPlayer.class).where("matchId=? and teamId=?",
        ...
        final PracticeRepairDialog repairDialog = new PracticeRepairDialog(this, DataRepairDialog.TYPE_ADD, playerList);
    ...
    private void doAddItem(final EventPartListResponse.HttpEvent httpEvent) {
        ...
        mLadderBallApi.doCommitTmpEventData(request)
...
//                            mRecyclerView.scrollToPosition(mAdapter.getItemCount() - 1);
    ...
    private void showEditDialog(final int position) {
        ...
        final PracticeRepairDialog repairDialog = new PracticeRepairDialog(this, DataRepairDialog.TYPE_EDIT, playerList);
