 ...
 */
public class RecordPlayerNumberAdapter extends RecyclerView.Adapter<RecordPlayerNumberAdapter.SingleChooseViewHolder> {
    ...
    public RecordPlayerNumberAdapter(Context context, List<Player> playerList) {
        mContext = context;
...
//第一部算出子item的基本高端，以8个player为基准
    ...
    public void changeItem(int position, Player player) {
...
//            ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, mItemHeight);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    dataRecord.itemType = RxBusTag.DataRecord.ITEM_PLAYER_CLICK;
