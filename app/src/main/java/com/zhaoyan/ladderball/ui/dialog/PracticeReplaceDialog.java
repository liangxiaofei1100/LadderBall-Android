 ...
 */
public class PracticeReplaceDialog extends BaseDialog implements BaseDialog.OnMenuClickListener {
    ...
    List<TmpPlayer> mPlayerList;

    public PracticeReplaceDialog(Context context, List<TmpPlayer> playerList) {
        super(context);
    ...
    public TmpPlayer getSelectPlayer() {
    ...
    public class ReplaceAdapter extends RecyclerView.Adapter<ReplaceAdapter.ReplaceViewHolder> {
        ...
        public void onBindViewHolder(ReplaceViewHolder holder, int position) {
            ...
            TmpPlayer player = mPlayerList.get(position);
